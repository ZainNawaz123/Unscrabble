...
export default function Board({ board, selected, onSelect }: BoardProps) {
  return (
    <div className="inline-block rounded-xl border-4 border-neutral-800 bg-neutral-900 p-3 shadow-sm">
      <div
            ...
            return (
              <button
                ...
                className={[
                  ...
                  isSelected ? "ring-1 ring-white ring-offset-1 ring-offset-neutral-900" : "",
                ].join(" ")}
              >
                {cell.letter}
              </button>
